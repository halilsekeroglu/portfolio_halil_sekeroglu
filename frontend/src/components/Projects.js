        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {data.map((project) => (
              <div 
                key={project.id}
                className={`rounded-lg border-2 p-8 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-lg ${getCategoryColor(project.category)}`}
              >
          ...
          <div className="text-center mt-16">
            ...
            <div className="inline-flex items-center space-x-2 px-8 py-3 border border-black hover:bg-black hover:text-white transition-all duration-300">
